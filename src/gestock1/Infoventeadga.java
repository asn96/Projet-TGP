 ...
 * @author lalita
 */
public class Infoventeadga extends JFrame{
    ...
    private void initComponents() {
        ...
        String et="facture";
            ...
            ResultSet b = a.executeQuery("SELECT * FROM ventegar WHERE Etat='"+et+"' ORDER BY Bonneref ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Infoventeadga().setVisible(true);
            }
        });
    }
    ...
    public void CreateColonne(){
     ...
     class Imprimer implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                MessageFormat hed = new MessageFormat("Liste des garnitures vendus");
