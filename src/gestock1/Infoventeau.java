 ...
 * @author lalita
 */
public class Infoventeau extends JFrame{
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon("pieces\\imprimer1.jpg"));
        ...
        String et="facture";
            ...
            ResultSet b = a.executeQuery("SELECT * FROM venteau WHERE Etat='"+et+"' ORDER BY Bonneref");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Infoventeau().setVisible(true);
            }
        });
    }
    ...
    public void CreateColonne(){
     ...
     class Imprimer implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                MessageFormat hed = new MessageFormat("Liste des autres produits vendus");
