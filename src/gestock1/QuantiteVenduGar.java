...
public class QuantiteVenduGar extends JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quantite de Garnitures vendues");
        jPanel5.add(jLabel1);
        ...
        CreateColonne();
         ...
         String dat= form.format(new Date());
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventegar WHERE Date='"+dat+"' GROUP BY bonneref ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuantiteVenduGar().setVisible(true);
            }
        });
    }
    ...
    public void ligne(int a,  int b, String c, String j, String e  ){
     ...
     class Afficher implements ActionListener {
          ...
          ligne(h, g, k, p ,fi);
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventegar WHERE (YEAR(Date)='"+datm1+"' AND MONTH(Date)='"+datm+"') GROUP BY bonneref ");
          ...
          ligne(h, g, k, p ,"le mois");
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventegar WHERE YEAR(Date)='"+datA+"' GROUP BY bonneref ");
          ...
          ligne(h, g, k, p ,"l'annee");
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventegar WHERE ((DAYOFMONTH(Date) BETWEEN '"+res+"' AND '"+sem+"') AND (YEAR(Date)='"+datm1+"' AND MONTH(Date)='"+datm+"')) GROUP BY bonneref ");
     ...
     class Quitter implements ActionListener {
      ...
      class Rechercher implements ActionListener {
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite) FROM ventegar WHERE bonneref='"+fp+"'");
      ...
      class Imprimer implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                MessageFormat hed = new MessageFormat("Liste des garnitures vendues");
