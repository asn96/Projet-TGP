...
public class QuantiteVenduPieces extends JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quantite de Pieces Detachees vendues");
        jPanel5.add(jLabel1);
        jLabel1.setBounds(180, 130, 370, 30);
       ...
       // jComboBox1.addItem("la Semaine");
        ...
        jButton1.setBounds(170, 20, 140, 27);
        ...
        jButton2.setBounds(20, 20, 120, 25);
        ...
        jButton3.setBounds(350, 20, 130, 29);
        ...
        jLabel6.setText("Developpee par:  Amad Said NDIAYE");
        jPanel6.add(jLabel6);
        jLabel6.setBounds(430, 10, 240, 16);
        ...
        jPanel1.setBounds(0, 500, 730, 150);
        ...
        CreateColonne();
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventepieces WHERE Date='"+dat+"' GROUP BY bonneref ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuantiteVenduPieces().setVisible(true);
            }
        });
    }
     ...
     public void ligne(int a,  int b, String c, String j, String e  ){
        ...
        class Afficher implements ActionListener {
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventepieces GROUP BY bonneref ");
          ...
          ligne(h, g, k, p ,fi);
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventepieces WHERE (YEAR(Date)='"+datm1+"' AND MONTH(Date)='"+datm+"') GROUP BY bonneref ");
          ...
          ligne(h, g, k, p ,"le mois");
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventepieces WHERE YEAR(Date)='"+datA+"' GROUP BY bonneref ");
          ...
          ligne(h, g, k, p ,"l'annee");
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite)  FROM ventepieces WHERE ((DAYOFMONTH(Date) BETWEEN '"+res+"' AND '"+sem+"') AND (YEAR(Date)='"+datm1+"' AND MONTH(Date)='"+datm+"')) GROUP BY bonneref ");
      ...
      class Rechercher implements ActionListener {
            ...
            ResultSet b = a.executeQuery("SELECT bonneref,coderef, Designation,  Quantite,  Date, SUM(Quantite) FROM ventepieces WHERE bonneref='"+fp+"'");
