...
public class Infopreesc extends JFrame{
    ...
    private void initComponents() {
        ...
        String et="pret";
            ...
            ResultSet b = a.executeQuery("SELECT * FROM ventepieces WHERE (Date='"+dat+"' AND Etat='"+et+"') ORDER BY Date DESC");
           ...
           String da;
            ...
            while(b.next()){
                ...
                ligne(bonn, cat, des, pri, qua, tot, idf, dat);
            ...
            ResultSet b = a.executeQuery("SELECT * FROM ventegar WHERE (Date='"+dat+"' AND Etat='"+et+"') ORDER BY Date DESC");
          
           int bonn;
           
           String cat="Garniture";
          ...
          try{
            ...
            ResultSet b = a.executeQuery("SELECT * FROM venteau WHERE (Date='"+dat+"' AND Etat='"+et+"') ORDER BY Date DESC");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Infopreesc().setVisible(true);
            }
        });
    }
    ...
    class Quitter implements ActionListener {
     ...
     class Imprimer implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                MessageFormat hed = new MessageFormat("Liste des produits empruntés");
