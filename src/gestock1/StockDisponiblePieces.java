...
public class StockDisponiblePieces extends JFrame implements Runnable{
     /**
	 * 
	 */
    ...
    public StockDisponiblePieces(){
     ...
     private void initComponents() {
        ...
        jLabel4.setText("Liste des Pieces Detachees Disponibles");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(240, 130, 360, 22);
        ...
        pack();
         ...
         CreateColonne();
            ...
            ResultSet b = a.executeQuery("SELECT * FROM Pieces ORDER BY bonneref");
     ...
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockDisponiblePieces().setVisible(true);
            }
        });
    }
    ...
    public void run() {
      ...
      class Rechercher implements ActionListener {
            ...
            ResultSet b = a.executeQuery("SELECT * FROM Pieces WHERE bonneref='"+fp+"'");
     ...
     class Imprimer implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                MessageFormat hed = new MessageFormat("Liste des Pieces detachees disponibles");
   ...
   class Modifier implements ActionListener {
            ...
            ResultSet b = a.executeQuery("SELECT * FROM pieces WHERE bonneref='"+ob+"'");
