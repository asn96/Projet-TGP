 ...
 * @author lalita
 */
public class Infoventsec extends JFrame{
    ...
    private void initComponents() {
        ...
        String et="facture";
            ...
            ResultSet b = a.executeQuery("SELECT * FROM ventepieces WHERE (Date='"+dat+"' AND Etat='"+et+"') ");
           ...
           String da;
            ...
            ResultSet b = a.executeQuery("SELECT * FROM ventegar WHERE (Date='"+dat+"' AND Etat='"+et+"') ");
          ...
          try{
            ...
            ResultSet b = a.executeQuery("SELECT * FROM venteau WHERE (Date='"+dat+"' AND Etat='"+et+"') ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Infoventsec().setVisible(true);
            }
        });
    }
